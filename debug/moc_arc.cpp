...
QT_MOC_LITERAL(1, 4, 6), // "select"
QT_MOC_LITERAL(2, 11, 0), // ""
QT_MOC_LITERAL(3, 12, 4), // "Arc*"
QT_MOC_LITERAL(4, 17, 3), // "arc"
QT_MOC_LITERAL(5, 21, 22), // "onSceneMoveableChanged"
QT_MOC_LITERAL(6, 44, 8) // "moveable"

    },
    "Arc\0select\0\0Arc*\0arc\0onSceneMoveableChanged\0"
    "moveable"
};
...
void Arc::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->select((*reinterpret_cast< Arc*(*)>(_a[1]))); break;
        ...
        {
            typedef void (Arc::*_t)(Arc * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Arc::select)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Arc::staticMetaObject = {
    { &Shape::staticMetaObject, qt_meta_stringdata_Arc.data,
