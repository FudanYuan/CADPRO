...
QT_MOC_LITERAL(1, 8, 18), // "projectNameChanged"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "Project\0projectNameChanged\0"
};
...
void Project::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->projectNameChanged((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Project::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Project::projectNameChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Project::projectNameChanged(QString _t1, QString _t2)
{
