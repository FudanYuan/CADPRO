...
CustomDockTitleBar::CustomDockTitleBar(QWidget *parent)
    : QWidget(parent)
{
...
QSize CustomDockTitleBar::minimumSizeHint() const
{
...
void CustomDockTitleBar::paintEvent(QPaintEvent*)
{
...
//void CustomDockTitleBar::updateMask()
//{
